...
urlpatterns = [
    ...
    path('family/', views.family_movies, name='family_movies'),
    path('history/', views.history_movies, name='history_movies'),
    path('documentary/', views.documentary_movies, name='documentary_movies'),
    path('thriller/', views.thriller_movies, name='thriller_movies'),
